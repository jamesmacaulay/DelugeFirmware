...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SLIDE_MORPH, "Slide Morph"},
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_INPUT_AUTO_FEEDBACK, "Input Auto Feedback"},
        ...
        {STRING_FOR_DEFAULT_CC_INPUT, "Default CC input"},
        ...
        {STRING_FOR_SECTION_LAUNCH_PC_INPUT, "Section Launch PC"},
        ...
        {STRING_FOR_LANDSCAPE_CONTOUR, "CONTOUR"},
        {STRING_FOR_LANDSCAPE_MAX_CONTOURS, "MAX 4 CONTOURS"},
        {STRING_FOR_LANDSCAPE_CONTOUR_DELETED, "CONTOUR DELETED"},
        {STRING_FOR_LANDSCAPE_LOADED, "LOADED"},
        {STRING_FOR_LANDSCAPE_OVERLAY_ON, "OVERLAY ON"},
        {STRING_FOR_LANDSCAPE_OVERLAY_OFF, "OVERLAY OFF"},
        {STRING_FOR_LANDSCAPE_NEUTRAL, "NEUTRAL"},
        {STRING_FOR_LANDSCAPE_NEUTRAL_LIMIT, "NEUTRAL LIMIT"},
        {STRING_FOR_LANDSCAPE_INDEX_HAS_AUTOMATION, "INDEX HAS AUTOMATION"},
        {STRING_FOR_LANDSCAPE_INDEXED, "(INDEXED)"},
        {STRING_FOR_LANDSCAPE_KNOB, "KNOB"},
        {STRING_FOR_LANDSCAPE_OUTPUT, "OUT"},
    },
};
} // namespace deluge::l10n::built_in
// clang-format on
