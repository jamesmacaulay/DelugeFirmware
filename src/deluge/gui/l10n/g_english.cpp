...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW1, "Channel Kit Row 1"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW2, "Channel Kit Row 2"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW3, "Channel Kit Row 3"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW4, "Channel Kit Row 4"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW5, "Channel Kit Row 5"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW6, "Channel Kit Row 6"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW7, "Channel Kit Row 7"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW8, "Channel Kit Row 8"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW9, "Channel Kit Row 9"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW10, "Channel Kit Row 10"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW11, "Channel Kit Row 11"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW12, "Channel Kit Row 12"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW13, "Channel Kit Row 13"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW14, "Channel Kit Row 14"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW15, "Channel Kit Row 15"},
        {STRING_FOR_FOLLOW_CHANNEL_KIT_ROW16, "Channel Kit Row 16"},
