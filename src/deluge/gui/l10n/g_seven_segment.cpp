...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SLIDE_MORPH, "SLID"},
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_INPUT_AUTO_FEEDBACK, "IAFB"},
        ...
        {STRING_FOR_SECTION_LAUNCH_PC_INPUT, "SPC"},
        ...
        {STRING_FOR_LANDSCAPE_INDEXED, "IDX"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
